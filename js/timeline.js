	...
	function Timeline(options) {
		...
		*/
		this.addMarkers = function(startDate,endDate, currZoom, currCenter,
			thisLayerID, thisLayerType, thisLayerUrl, thisLayerColor,baseUrl)
		{

			var	protocolUrl = baseUrl + "json/cluster/"; // Default Json
			...
			markers = new OpenLayers.Layer.GMLOpenSocial(thisLayer, protocolUrl + '?z=' +
